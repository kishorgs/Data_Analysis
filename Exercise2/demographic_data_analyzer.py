...
def calculate_demographic_data(print_data=True):
    ...
    # What percentage of people who work minimum hours have >50K?
    ...
    country_rich_pct = (
        country_salary.value_counts(normalize=True)
        .unstack()
        .fillna(0)
        ['>50K'] * 100
    )
...
if __name__ == "__main__":
    print(calculate_demographic_data(True))